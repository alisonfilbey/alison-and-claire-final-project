...
ax = hp_roads_gdf.plot(color='blue', linewidth=1, figsize=(10, 8), label='Original LineStrings')
buffered_gdf.plot(ax=ax, color='lightblue', alpha=0.5, label='Buffer')
hp_crashes_gdf.plot(ax=ax, color="black", markersize=0.5)
