...
alt.Chart(ped_action, title= "Number of Crashes Involving Pedestrians by the Action of the Pedestrian").mark_bar().encode(
    x=alt.X('PEDPEDAL_ACTION:O', sort='y', axis=alt.Axis(title= 'Action of Pedestrian', labelFontSize=6, labelAngle=60)),
    y=alt.Y("sum(n_peds_severe):Q", axis=alt.Axis(title= 'Number'))
)
```
